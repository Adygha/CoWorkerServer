...
//		MEDIA_UNSUPPORTED,
	...
	public MyRequest(String reqString) {
		...
		this.meRequestStr = tmpArr[0].trim(); // Get the request string
		this.mePath = tmpArr[1].trim(); // Get the request string
		if (tmpArr[0].startsWith("HTML")) {
			this.meReqType = RequestType.HTML_GET;
		} else if (tmpArr[0].startsWith("DATA")) {
			this.meReqType = RequestType.DATA_GET;
		} else {
...
//			}
	...
	/**
	 * Returns the original request string of this HTTP request object.
	 * @return	the original request string of this HTTP request object.
	 */
	public String getRequstString() {
		return this.meRequestStr;
	}
	...
	/**
	 * Sets a new relative path for this HTTP request object.
	 * @param	the new path for this HTTP request object
	 */
